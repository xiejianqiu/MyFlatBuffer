...
public sealed class FB_HuanJingLevel : Table {
  ...
  public int HuanJingLevel { get { int o = __offset(6); return o != 0 ? bb.GetInt(o + bb_pos) : (int)-1; } }
  ...
  public static Offset<FB_HuanJingLevel> CreateFB_HuanJingLevel(FlatBufferBuilder builder,
    ...
    FB_HuanJingLevel.AddDESC(builder, DESC);
  ...
  public static void AddHuanJingLevel(FlatBufferBuilder builder, int HuanJingLevel) { builder.AddInt(1, HuanJingLevel, -1); }
