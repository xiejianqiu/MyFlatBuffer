...
public sealed class FB_PetBase : Table {
  ...
  public static Offset<FB_PetBase> CreateFB_PetBase(FlatBufferBuilder builder,
    ...
    FB_PetBase.AddAttrValueList(builder, AttrValueList);
    FB_PetBase.AddAttrIdList(builder, AttrIdList);
  ...
  public static void StartFB_PetBase(FlatBufferBuilder builder) { builder.StartObject(15); }
