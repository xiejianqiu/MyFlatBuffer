...
public sealed class FB_ChatLimit : Table {
  ...
  public int RechargeRMBLimit { get { int o = __offset(32); return o != 0 ? bb.GetInt(o + bb_pos) : (int)-1; } }
  public int RechargeYuanBaoLimit { get { int o = __offset(34); return o != 0 ? bb.GetInt(o + bb_pos) : (int)-1; } }
  public int TotalRMBLimit { get { int o = __offset(36); return o != 0 ? bb.GetInt(o + bb_pos) : (int)-1; } }
  ...
  public static Offset<FB_ChatLimit> CreateFB_ChatLimit(FlatBufferBuilder builder,
      ...
      int VIPLevel = -1,
      int VIPTimeLimit = -1,
      int RechargeRMBLimit = -1,
      int RechargeYuanBaoLimit = -1,
      int TotalRMBLimit = -1) {
    builder.StartObject(17);
    FB_ChatLimit.AddTotalRMBLimit(builder, TotalRMBLimit);
    FB_ChatLimit.AddRechargeYuanBaoLimit(builder, RechargeYuanBaoLimit);
    FB_ChatLimit.AddRechargeRMBLimit(builder, RechargeRMBLimit);
  ...
  public static void StartFB_ChatLimit(FlatBufferBuilder builder) { builder.StartObject(17); }
  ...
  public static void AddRechargeRMBLimit(FlatBufferBuilder builder, int RechargeRMBLimit) { builder.AddInt(14, RechargeRMBLimit, -1); }
  public static void AddRechargeYuanBaoLimit(FlatBufferBuilder builder, int RechargeYuanBaoLimit) { builder.AddInt(15, RechargeYuanBaoLimit, -1); }
  public static void AddTotalRMBLimit(FlatBufferBuilder builder, int TotalRMBLimit) { builder.AddInt(16, TotalRMBLimit, -1); }
