...
public sealed class FB_FakeObject : Table {
  ...
  public bool RongYaoTime { get { int o = __offset(42); return o != 0 ? 0!=bb.Get(o + bb_pos) : (bool)false; } }
  ...
  public static Offset<FB_FakeObject> CreateFB_FakeObject(FlatBufferBuilder builder,
    ...
    FB_FakeObject.AddRongYaoTime(builder, RongYaoTime);
  ...
  public static void StartFB_FakeObject(FlatBufferBuilder builder) { builder.StartObject(20); }
  ...
  public static void AddRongYaoTime(FlatBufferBuilder builder, bool RongYaoTime) { builder.AddBool(19, RongYaoTime, false); }
