...
public sealed class FB_LevelSealBase : Table {
  ...
  public int SeverOpenDay { get { int o = __offset(14); return o != 0 ? bb.GetInt(o + bb_pos) : (int)-1; } }
  ...
  public static Offset<FB_LevelSealBase> CreateFB_LevelSealBase(FlatBufferBuilder builder,
    ...
    FB_LevelSealBase.AddSeverOpenDay(builder, SeverOpenDay);
  ...
  public static void StartFB_LevelSealBase(FlatBufferBuilder builder) { builder.StartObject(6); }
  ...
  public static void AddSeverOpenDay(FlatBufferBuilder builder, int SeverOpenDay) { builder.AddInt(5, SeverOpenDay, -1); }
