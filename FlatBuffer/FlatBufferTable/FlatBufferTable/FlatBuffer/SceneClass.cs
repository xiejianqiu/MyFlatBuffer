...
public sealed class FB_SceneClass : Table {
  ...
  public int CreateRunningMonsterNum { get { int o = __offset(172); return o != 0 ? bb.GetInt(o + bb_pos) : (int)0; } }
  public int CreateRunningMonsterGap { get { int o = __offset(174); return o != 0 ? bb.GetInt(o + bb_pos) : (int)0; } }
  ...
  public static Offset<FB_SceneClass> CreateFB_SceneClass(FlatBufferBuilder builder,
      ...
      int CreateRunningMonsterNum = 0,
      int CreateRunningMonsterGap = 0) {
    builder.StartObject(86);
    FB_SceneClass.AddPowerLimit(builder, PowerLimit);
    FB_SceneClass.AddCreateRunningMonsterGap(builder, CreateRunningMonsterGap);
    FB_SceneClass.AddCreateRunningMonsterNum(builder, CreateRunningMonsterNum);
  ...
  public static void StartFB_SceneClass(FlatBufferBuilder builder) { builder.StartObject(86); }
  ...
  public static void AddCreateRunningMonsterNum(FlatBufferBuilder builder, int CreateRunningMonsterNum) { builder.AddInt(84, CreateRunningMonsterNum, 0); }
  public static void AddCreateRunningMonsterGap(FlatBufferBuilder builder, int CreateRunningMonsterGap) { builder.AddInt(85, CreateRunningMonsterGap, 0); }
