...
public sealed class FB_MaiDianPart : Table {
  ...
  public bool IsLevelHundred { get { int o = __offset(16); return o != 0 ? 0!=bb.Get(o + bb_pos) : (bool)false; } }
  ...
  public static Offset<FB_MaiDianPart> CreateFB_MaiDianPart(FlatBufferBuilder builder,
    ...
    FB_MaiDianPart.AddIsLevelHundred(builder, IsLevelHundred);
    return FB_MaiDianPart.EndFB_MaiDianPart(builder);
  }

  public static void StartFB_MaiDianPart(FlatBufferBuilder builder) { builder.StartObject(7); }
  ...
  public static void AddIsLevelHundred(FlatBufferBuilder builder, bool IsLevelHundred) { builder.AddBool(6, IsLevelHundred, false); }
