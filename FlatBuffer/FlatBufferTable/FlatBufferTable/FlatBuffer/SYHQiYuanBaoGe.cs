...
public sealed class FB_SYHQiYuanBaoGe : Table {
  ...
  public int GetShowItemNumList(int j) { int o = __offset(26); return o != 0 ? bb.GetInt(__vector(o) + j * 4) : (int)0; }
  public int ShowItemNumListLength { get { int o = __offset(26); return o != 0 ? __vector_len(o) : 0; } }
  ...
  public static Offset<FB_SYHQiYuanBaoGe> CreateFB_SYHQiYuanBaoGe(FlatBufferBuilder builder,
    ...
    FB_SYHQiYuanBaoGe.AddShowItemNumList(builder, ShowItemNumList);
    FB_SYHQiYuanBaoGe.AddShowItemIdList(builder, ShowItemIdList);
  ...
  public static void StartFB_SYHQiYuanBaoGe(FlatBufferBuilder builder) { builder.StartObject(12); }
  ...
  public static void AddShowItemNumList(FlatBufferBuilder builder, VectorOffset ShowItemNumListOffset) { builder.AddOffset(11, ShowItemNumListOffset.Value, 0); }
