...
public sealed class FB_StarSoulUnitBase : Table {
  ...
  public int OpenServerDay { get { int o = __offset(64); return o != 0 ? bb.GetInt(o + bb_pos) : (int)0; } }
  public bool IsShowOnUI { get { int o = __offset(66); return o != 0 ? 0!=bb.Get(o + bb_pos) : (bool)false; } }
  public int ShangZhenFakeObjID { get { int o = __offset(68); return o != 0 ? bb.GetInt(o + bb_pos) : (int)-1; } }
  ...
  public static Offset<FB_StarSoulUnitBase> CreateFB_StarSoulUnitBase(FlatBufferBuilder builder,
      ...
      int ShangZhenFakeObjID = -1) {
    builder.StartObject(33);
    FB_StarSoulUnitBase.AddShangZhenFakeObjID(builder, ShangZhenFakeObjID);
    FB_StarSoulUnitBase.AddOpenServerDay(builder, OpenServerDay);
    ...
    FB_StarSoulUnitBase.AddIsShowOnUI(builder, IsShowOnUI);
    FB_StarSoulUnitBase.AddCanDecompose(builder, CanDecompose);
    return FB_StarSoulUnitBase.EndFB_StarSoulUnitBase(builder);
  }

  public static void StartFB_StarSoulUnitBase(FlatBufferBuilder builder) { builder.StartObject(33); }
  ...
  public static void AddOpenServerDay(FlatBufferBuilder builder, int OpenServerDay) { builder.AddInt(30, OpenServerDay, 0); }
  public static void AddIsShowOnUI(FlatBufferBuilder builder, bool IsShowOnUI) { builder.AddBool(31, IsShowOnUI, false); }
  public static void AddShangZhenFakeObjID(FlatBufferBuilder builder, int ShangZhenFakeObjID) { builder.AddInt(32, ShangZhenFakeObjID, -1); }
